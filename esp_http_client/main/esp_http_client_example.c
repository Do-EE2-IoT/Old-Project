...
esp_http_client_config_t config = {
    ...
    .user_data = local_response_buffer, // Địa chỉ của buffer để nhận phản hồi
};
...
// POST
const char *post_data = "{\"title1\":\"This is signal from esp32\",\"content1\":\"If success in this, you can use for smart door\",\"price1\":500}";
// esp_http_client_set_url(client, "http://127.0.0.1:8000/course/"); // Sử dụng đường dẫn tương đối
