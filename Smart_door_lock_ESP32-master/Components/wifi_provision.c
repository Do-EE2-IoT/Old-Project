...
#define EXAMPLE_PROV_SEC2_PWD               "12345678"

/* This salt,verifier has been generated for username = "wifiprov" and password = "12345678"
    ...
    if (event_base == WIFI_PROV_EVENT) {
        switch (event_id) {
            ...
            case WIFI_PROV_CRED_RECV: {
                ...
                ESP_LOGI(TAG, "Received Wi-Fi crhedentials"
                         "\n\tSSID     : %s\n\tPassword : %s",
...
void init_wifi_provisioning_via_ble()
{
    /* Initialize TCP/IP */
...
#else
    ESP_LOGI(TAG, "Device is connected to Wifi network!");
    while (1) {
        vTaskDelay(1000 / portTICK_PERIOD_MS);
    }
#endif
